...
Current efforts are focused on reviewing additional papers to identify more remittance data. It may also be worthwhile to focus on individual countries, such as Georgia or the Philippines, to obtain more complete datasets.

Based from other papers More data on remitance can be potentiaonally found on Italy and Tonga
Based of Dean Yang's work detailed ifnroamtiaon on remtiances cna be found on Philippines, suvrveyers, central banks, remtiance providers, etc. 

I also found soth asia remtiance dataset ehre https://dataverse.harvard.edu/file.xhtml?fileId=10224832&version=1.0

its made by this guy im not sure if we shoul merge it with ours im happy to hear your thoughts https://cpd.org.bd/distinguished-fellows/professor-mustafizur-rahman/

It says the data came from centrla bank btu tat the sametime i amnot fmailiar with this intistitusion
...
I also focusing efforts on studying other papers for similar datasets that did not use population thresholds.

**Remittance Data Construction:**


Additionally, the Kpodar dataset provides a more detailed disaggregation of remittances by these metrics. I mention it here for reference, if it may be of interest for further analysis.
...
## Overview
This analysis examines remittance flows using data extracted from Remitscope, and shows how the remitscope dataset changes upon the addition of Kpodars data
...
- Kpodar's dataset is significantly more than Remitscope dataset. Though this is attributed mainly to 2 countries Georgia and Philippines, more details shown below. 
...
![Remitscsope and Kpodar Sending countries map](images/10.png)


top 30 sending countries Remitscsope and Kpodar ![](images/14.png)

### Receiving Countries Analysis

![Remitscope Recieving Countries Map](images/4.png){#fig-receiving-additional width=100%}
...
![top 30 recieving coutnries Remitscsope and Kpodar](images/13.png)
...
The receiving countries are heavily concentrated in Latin America in the original dataset, with Ecuador (183 records) and Mexico (169 records) as the primary recipients.
