...
<tr><td style="text-align:left"></td><td colspan="2">Δ Remittance (thousands)</td><td colspan="2">% Δ Remittance</td><td colspan="2">Δ Remittance (millions)</td><td colspan="2">Δ Remittance (thousands)</td><td colspan="2">% Δ Remittance</td><td colspan="2">Δ Remittance (millions)</td></tr>
...
<tr><td style="text-align:left">Specification</td><td>1: Linear</td><td>1: Linear</td><td>2: % Change</td><td>2: % Change</td><td>3: Linear (mil)</td><td>3: Linear (mil)</td><td>1: Linear</td><td>1: Linear</td><td>2: % Change</td><td>2: % Change</td><td>3: Linear (mil)</td><td>3: Linear (mil)</td></tr>
...
<tr><td style="text-align:left">% Δ Sending GDP Per Capita</td><td></td><td></td><td>0.848</td><td>0.781</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
<tr><td style="text-align:left"></td><td></td><td></td><td>(0.977)</td><td>(1.003)</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
<tr><td style="text-align:left">% Δ Receiving GDP Per Capita</td><td></td><td></td><td>-0.292</td><td>-0.230</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
<tr><td style="text-align:left"></td><td></td><td></td><td>(1.099)</td><td>(1.155)</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
...
<tr><td style="text-align:left">% Δ Sending GDP Per Capita (t-1)</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>-0.022</td><td>-0.010</td><td></td><td></td></tr>
<tr><td style="text-align:left"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>(0.074)</td><td>(0.078)</td><td></td><td></td></tr>
<tr><td style="text-align:left">% Δ Receiving GDP Per Capita (t-1)</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>-0.142<sup>*</sup></td><td>-0.155<sup>*</sup></td><td></td><td></td></tr>
<tr><td style="text-align:left"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>(0.062)</td><td>(0.065)</td><td></td><td></td></tr>
...
<tr><td style="text-align:left">R<sup>2</sup></td><td>0.003</td><td>0.020</td><td>0.001</td><td>0.001</td><td>0.003</td><td>0.020</td><td>0.008</td><td>0.020</td><td>0.011</td><td>0.012</td><td>0.008</td><td>0.020</td></tr>
...
Δ denotes change (first difference), % Δ denotes percentage change<br>
Specification 1: Linear change in remittances vs linear change in GDP per capita<br>
Specification 2: Percentage change model for elasticity-type interpretation<br>
Specification 3: Linear change in remittances (millions) vs linear change in GDP per capita<br>
...
\cline{2-13}
\\[-1.8ex] & \multicolumn{2}{c}{$\Delta$ Remittance (thousands)} & \multicolumn{2}{c}{\% $\Delta$ Remittance} & \multicolumn{2}{c}{$\Delta$ Remittance (millions)} & \multicolumn{2}{c}{$\Delta$ Remittance (thousands)} & \multicolumn{2}{c}{\% $\Delta$ Remittance} & \multicolumn{2}{c}{$\Delta$ Remittance (millions)} \\
...
\hline
\hline \\[-1.8ex]
\textit{Note:}  & \multicolumn{12}{r}{$\Delta$ denotes change (first difference), \% $\Delta$ denotes percentage change} \\
 & \multicolumn{12}{r}{Specification 1: Linear change, Specification 2: Percentage change, Specification 3: Linear change (millions)} \\
...
| | **Δ Remittance (thousands)** | | **% Δ Remittance** | | **Δ Remittance (millions)** | | **Δ Remittance (thousands)** | | **% Δ Remittance** | | **Δ Remittance (millions)** | |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| | **Unlagged** | **Unlagged** | **Unlagged** | **Unlagged** | **Unlagged** | **Unlagged** | **Lagged** | **Lagged** | **Lagged** | **Lagged** | **Lagged** | **Lagged** |
| | With Outliers | Without Outliers | With Outliers | Without Outliers | With Outliers | Without Outliers | With Outliers | Without Outliers | With Outliers | Without Outliers | With Outliers | Without Outliers |
| | Spec 1 | Spec 1 | Spec 2 | Spec 2 | Spec 3 | Spec 3 | Spec 1 | Spec 1 | Spec 2 | Spec 2 | Spec 3 | Spec 3 |
...
- Specification 2: Percentage change model for elasticity-type interpretation  
- Specification 3: Linear change in remittances (millions) vs linear change in GDP per capita
...
SPECIFICATIONS: Linear (thousands), Percentage Change, Linear (millions)
